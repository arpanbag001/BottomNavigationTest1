 ...
 * @hide
 */
public class CustomBottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public CustomBottomNavigationItemView(@NonNull Context context) {
        this(context, null);
    }

    public CustomBottomNavigationItemView(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomBottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
